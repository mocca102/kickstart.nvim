...
vim.keymap.set('n', '<leader>ud', function()
  ...
  vim.diagnostic.config { virtual_text = not current and { source = 'if_many', spacing = 2 } or false }
...
-- Split navigation is handled by vim-tmux-navigator plugin (C-h/j/k/l)
